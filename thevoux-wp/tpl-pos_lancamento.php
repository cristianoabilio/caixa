          ...
          <section id="selecoes" class="text-xs-center">
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 item">
				<a href="<?php echo home_url('/selecoes/treze_tilias-sc'); ?>" class="">
                  <div class="overlay">
                  ...
                  <div class="text">
                    <h3 class="text-uppercase"><strong>Treze Tílias</strong>Santa Catarina</h3>
                  </div>
                  <span class="img-selecoes">
                      <span class="img-selecoes-inner">
                          <img src="<?php echo home_url('/'); ?>dist/images/capa-trezetilias-home2.jpg" alt="Treze Tílias - SC">
                      </span>
                  </span>
                </a>
              </div>
